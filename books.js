...
const displaySearchResult = (searchBooks) => {
    ...
    if (searchBooks.length == 0) {
        ...
        searchBooks.forEach(searchBook => {
            ...
            div.innerHTML = `
            <div class="card h-100 result background-colour">
                    <div class="card-body">
                    ...
                    <div class="card-footer">
                        ...
                        <h5 class="card-title"><span class="fw-bold">Author Name: </span>${searchBook.author_name}</h5>
                        <h5 class="card-title"><span class="fw-bold">Publisher Name: </span>${searchBook.publisher}</h5>
